...
<<alzheimer-probci, echo = TRUE, echo = FALSE>>=
...
\begin{figure}[h]
\begin{center}
<<alzheimer-plot, echo = FALSE, fig = TRUE, mai2 = TRUE, width = 7, height = 5>>=
gmod_ci <- confint(glht(gmod, linfct = K))
gmod_ci$confint <- apply(gmod_ci$confint, 2, binomial()$linkinv)
plot(gmod_ci, xlab = "Probability of Developing Alzheimer", 
...
\begin{figure}[t]
\begin{center}
<<trees-plot, echo = FALSE, mai3 = TRUE, fig = TRUE, width = 7, height = 4.5>>=
