...
\title{On Multiple Test Procedures for Linear Hypotheses}
...
Our primary target is inference about 
...
\end{eqnarray*}
We only consider inference procedures, both tests and confidence intervals,
